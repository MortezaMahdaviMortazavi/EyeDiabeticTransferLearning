...
if __name__ == "__main__":
    fast_image_resize("../EyeDiabeticDetectionTrainset/", "../train/images_resized_300/", output_size=(300, 300))
    # fast_image_resize("../test/images/", "../test/images_resized_300/", output_size=(300, 300))